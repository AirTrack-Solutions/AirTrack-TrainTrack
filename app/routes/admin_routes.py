...
def cockpit():
    ...
    try:
        with db.engine.connect() as conn:
            ...
            selected_theme = theme_row[0] if theme_row and theme_row[0] else "default"
    except Exception:
        recent_cops = []
        selected_theme = "default"
    return render_template("admin_cockpit.html", stats=stats,
                           recent_cops=recent_cops, selected_theme=selected_theme)
