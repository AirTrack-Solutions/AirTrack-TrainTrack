...
STAGING_DIR = BASE_DIR / "static" / "updates"

UPDATE_BASE_URL = "https://www.airtracksolutions.com/updates/traintrack/"
...
logger = logging.getLogger("traintrack_updater")
